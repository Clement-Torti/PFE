...
export  function FIRST_BLOCK(PYTHON_INDENT: string) {
...
${PYTHON_INDENT}${PYTHON_INDENT}#super (self, "testHGMicro_TC48_CommunicationThompsonScaleTBS705").__init__(parent)
${PYTHON_INDENT}${PYTHON_INDENT}super().__init__("testHGMicro_SoftwareVerificationProtocolAppli", parent)
${PYTHON_INDENT}${PYTHON_INDENT}`;
}


export  function SECOND_BLOCK(PYTHON_INDENT: string) {
    return `${PYTHON_INDENT}${PYTHON_INDENT}#Setup and start the thread
...
export  function THIRD_BLOCK(PYTHON_INDENT: string) {
    return `${PYTHON_INDENT}${PYTHON_INDENT}def executeSteps(self):
${PYTHON_INDENT}${PYTHON_INDENT}`;
}


export  function FOURTH_BLOCK(PYTHON_INDENT: string) {
    return `${PYTHON_INDENT}${PYTHON_INDENT}for step in steps:
